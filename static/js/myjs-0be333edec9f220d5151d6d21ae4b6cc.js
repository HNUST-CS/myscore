...
(function() {
  ...
  $(document).ready(function() {
    var checkFailCourse, circle, clear, jsonData, setPosition, settleFile, waveloop1, waveloop2;
    jsonData = '';
    ...
    $('#update-bt').click(function() {
      return $(circle.canvas).appendTo('#update-ct');
    });
     ...
     */
    if ($.cookie('no-record') !== 'true') {
      $('#record').modal('show');
    }
    if ($.cookie('number') && $.cookie('sfz')) {
      $('#input1').val($.cookie('number'));
      $('#sfz-4').val($.cookie('sfz'));
    }
    return $('#record-bt').click(function() {
      if (document.getElementsByClassName('no-record')[0].checked === true) {
        return $.cookie('no-record', 'true');
      }
    });
  });
