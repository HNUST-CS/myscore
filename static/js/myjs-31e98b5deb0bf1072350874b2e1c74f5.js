...
(function() {
  ...
  $(document).ready(function() {
    ...
    doc = ['本站本来是我们突发奇想一个通宵做出来的小玩具', '没想到上线之后得到了这么多同学的支持', '很高兴本站能够带给同学们一点点的便捷', '看到同学们相继转发，评论，支持，我们真的非常感动', '所以尽管在期末到处考试一堆的情况下还是尽全力去维护', '每天1W,2W上涨的访问量更是给与我们了无限的动力', '由于撸主是大二学生，顶不住学校给"恐吓"和压力', '迫于无奈之举，今天正式关闭本网站', '不过，结束就是下一个开始', '未来我们肯定努力去做出更多更好玩的东西带给大家来分享。', '不管怎样最后还是要说一句', '-----谢谢！-----', '-----END-----'];
    cnt = 0;
    max = doc.length;
    change = function() {
      cnt++;
